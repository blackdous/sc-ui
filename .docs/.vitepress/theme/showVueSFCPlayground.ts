  ...
  Array.from(codeDom).map(item => {
    ...
    if (ClickDom) {
      ...
      `.trim()?.replace("/* @import 'comment'; */", (item) => {
        // 
        return "@import 'https://cdn.jsdelivr.net/npm/@sincerecloud/sc-ui@0.0.196/style.css';"
      });
      const files = {
          ...
          JSON.stringify(
            {
              imports: {
                ...
                "sc-ui": "https://cdn.jsdelivr.net/npm/@sincerecloud/sc-ui@0.0.196/sc-ui.es.min.js",
