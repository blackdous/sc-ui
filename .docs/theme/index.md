...
@shadow-color: 0px 4px 4px rgb(35 166 243 / 8%), 0px 0px 6px #f0f3f7;

@primary-shadow: 0px 0px 8px rgba(0, 140, 211, 0.5); // 主题渐变色

@error-shadow: 0px 2px 8px rgba(245, 63, 63, 0.5); // 错误渐变色

//************************** steps
// steps-wait-color
@steps-wait-color: #F5F5F5;
// steps-process-color
