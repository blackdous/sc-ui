...
<script lang="ts">
  ...
  import { ScForm, FormSchema, ApiSelect, useMessage } from 'sc-ui';

  import { useDebounceFn } from '@vueuse/core';
  import { Select } from 'ant-design-vue';
  import cloneDeep from 'lodash/cloneDeep';

  import { optionsListApi, treeOptionsListApi } from './form.data';
  ...
  export default defineComponent({
    components: { ScForm, ApiSelect, ASelect: Select },
    setup() {
      ...
      return {
        ...
        handleSubmit: (values: any) => {
          ...
          // createCloseMessage.success('click search,values:' + JSON.stringify(values));
